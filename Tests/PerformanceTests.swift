...
final class PerformanceTests: XCTestCase {
    ...
    func testBuildPerformance() {
        ...
        builder.expression = Expression(id: "t", face: "´∀`", category: "happy", tags: [])
    ...
    func testTotalPartsCount() {
        ...
        let data = KaomojiData.shared
        let total = data.expressions.count + data.brackets.count + data.hands.count + data.decorations.count + data.actions.count
        XCTAssertLessThan(total, 300, "Total parts should be under 300, got \(total)")
    }
}
